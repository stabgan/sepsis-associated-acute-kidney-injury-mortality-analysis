...
| --- | --- | --- | --- |
| Figure 1 | Cohort definition and evaluation workflow | 02_methods.md (mermaid) | saaki/jamia_manuscript/02_methods.md |
| Figure 2 | Prediction ceiling and benchmark summary | prediction_ceiling.png | local_outputs/artifacts/prediction_ceiling.png |
| Figure 3 | Conformal selective-triage decision framework | 02_methods.md (mermaid) | saaki/jamia_manuscript/02_methods.md |
